    ...
    ConditionSqlNode &condition, FilterUnit *&filter_unit)
{
  ...
  build_expression(condition.left_expression.get(), table_wrap, *tables, field_wrap, db->name());
  ...
  build_expression(condition.right_expression.get(), table_wrap, *tables, field_wrap, db->name());
